...
path='/le/chemin/absolue/vers/ce/répertoire'

myMQTTClient.configureEndpoint("xxxxxxxxxxxxxx.iot.us-west-2.amazonaws.com", 8883)
myMQTTClient.configureCredentials(path+'VeriSign-Class 3-Public-Primary-Certification-Authority-G5.pem'
                                  , path+'1d8bf2c1a7-certificate.pem.key',
                                  path+'1d8bf2c1a7-certificate.pem.crt'
                                  )
##################################################################################
